 ...
 * @since 1.0
 */
public class CollectionTextFieldParserTest extends ParserTest {
    ...
    public void testCollectionDelimited() {
        ...
        try (BeanReader in = factory.createReader("dc1", new InputStreamReader(
    ...
    public void testNullPrimiitve() {
        ...
        try (BeanReader in = factory.createReader("dc2", new InputStreamReader(
    ...
    public void testCollectionFixedLength() {
        ...
        try (BeanReader in = factory.createReader("fc1", new InputStreamReader(
