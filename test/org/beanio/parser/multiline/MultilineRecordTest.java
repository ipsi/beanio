...
public class MultilineRecordTest extends ParserTest {
    ...
    public void testRecordGroup() throws ParseException {
        ...
        try (BeanReader in = factory.createReader("ml1", new InputStreamReader(
    ...
    public void testNestedRecorGroup() throws ParseException {
        ...
        try (BeanReader in = factory.createReader("ml2", new InputStreamReader(
    ...
    public void testNestedRecorGroupCollections() throws ParseException {
        ...
        try (BeanReader in = factory.createReader("ml3", new InputStreamReader(
    ...
    public void testRecordMap() throws ParseException {
        ...
        try (BeanReader in = factory.createReader("ml4", new InputStreamReader(
    ...
    public void testNestedRecorGroupNonCollection() throws ParseException {
        ...
        try (BeanReader in = factory.createReader("ml5", new InputStreamReader(
    ...
    public void testEmptyRecordList() throws ParseException {
        ...
        try (BeanReader in = factory.createReader("ml6", new InputStreamReader(
    ...
    public void testInlineRecordMap() throws ParseException {
        ...
        try (BeanReader in = factory.createReader("ml7", new InputStreamReader(
    ...
    public void testOptionalRecord() {
        ...
        assertEquals(output.toString(), text);
    }
}
